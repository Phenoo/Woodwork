  ...
  return (
    <div className="bg-[#948575] px-4 py-8 md:p-12">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 mt-4 place-items-center py-4">
        <article className='bg-[#fff] text-black p-4 rounded-sm grid grid-col-1 lg:grid-cols-2 gap-2 max-w-[600px] h-[350px]  cursor-pointer'>
        ...
        <article className='bg-[#ddf] text-black p-4 rounded-sm grid grid-col-1 lg:grid-cols-2 gap-2 max-w-[600px] h-[350px] cursor-pointer'>
          <div className='lg:order-none order-2'>
            <h4 className="text-xl lg:text-2xl font-bold capitalize mb-1">
              The best chair <br />
              Drokus CG1
